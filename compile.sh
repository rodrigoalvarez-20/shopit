...
cd ~/shopit
javac -cp $CATALINA_HOME/lib/javax.ws.rs-api-2.0.1.jar:$CATALINA_HOME/lib/gson-2.3.1.jar:$CATALINA_HOME/lib/java-jwt-3.3.0.jar:$CATALINA_HOME/lib/jackson-core-2.13.2.jar:$CATALINA_HOME/lib/apache-commons.jar:. business/Service.java
